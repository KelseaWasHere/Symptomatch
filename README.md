Symptomatch is a user-friendly app that allows the user to type in their medical symptoms and be provided with a list of possible conditions which are personalized using user data.
